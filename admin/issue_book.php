...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
        ...
        <div class="form-card">
         <center><h2>Issue Book</h2><br></center>   
		<div class="row">
...
<?php
	if(isset($_POST['issue_book']))
	{
		$connection = mysqli_connect("localhost","root","vikash123");
		$db = mysqli_select_db($connection,"project2");
		$query = "insert into issuee_books values(null,$_POST[book_no],'$_POST[book_name]','$_POST[book_author]',$_POST[student_id],1,'$_POST[issue_date]')";
		$query_run = mysqli_query($connection,$query);
